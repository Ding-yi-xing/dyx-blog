...
- **响应式设计**：完美支持桌面端与移动端
- **主题切换**：自动/手动深浅色主题切换
- **安全加固**：JWT 认证、RBAC 权限、XSS 防护、敏感信息加密
- **富文本编辑**：支持博客/动态富文本内容编辑与展示
- **图片放大预览**：支持图片点击放大查看
- **足迹地图**：全国省市区三级联动足迹展示
...
export ENCRYPT_KEY=your_32_char_key
...
### 前台功能
- **首页**：Hero 首屏、最新动态、精选项目、足迹地图
- **关于我**：个人资料、作品展示、荣誉时间线
- **简历**：教育/工作/项目经历、PDF 下载、打印支持
- **博客**：文章列表、详情阅读、富文本展示
- **动态**：时间流式内容展示
- **留言**：访客留言互动
...
| 特性 | 说明 |
|------|------|
| JWT 认证 | Token 鉴权，支持角色权限 |
| RBAC 权限 | ADMIN/USER 双角色权限控制 |
| XSS 防护 | Jsoup 白名单清洗 |
| 密码加密 | BCrypt 强哈希存储 |
| 敏感信息加密 | AES 加密存储 OSS 密钥等 |
