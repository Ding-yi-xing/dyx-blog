...
const summaryItems = computed(() => [
  ...
  { label: '项目数量', value: String(summary.value.projectCount ?? 0), tip: '用于展示项目经历条目数' },
